    ...
    <div class="container">
        ...
        <div class="quantity">
            ...
            <button type="button" class="btn btn-primary" style="margin-left: 3px; margin-bottom: 3px"
                data-bs-toggle="modal" data-bs-target="#modal" title="Thêm quyển sách"><i class="fa-solid fa-plus"></i>
            </button>
        </div>
        <!-- The Modal -->
                        ...
                        <div class="modal-body">
                            <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="title_name" name="title_name" value ="<?= $title['title_name'] ?>" disabled>
                                </div>
                                <div class="mb-3">
                                    <label for="book_added_day" class="form-label"><b>Ngày thêm:</b></label>
                                    <input class="form-control" value ="<?= date('d-m-Y') ?>" disabled>
                                </div>
                                <input id="book_added_day" name="book_added_day" hidden value ="<?= date('d-m-Y') ?>">
                                <div class="mb-3">
