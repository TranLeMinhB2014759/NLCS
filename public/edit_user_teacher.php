...
if (isset($_POST['id'])) {
    ...
    $query = 'UPDATE user SET username=?, fullname=?, password=?, sdt=?, email=?, file_avatar=? WHERE user_id=?';
        ...
        <section class="manage">
            <div class="container-form">
                ...
                <?php if (isset($_GET['id'])) {
                    $query = "SELECT user_id, fullname, username, password, sdt, email, file_avatar FROM user WHERE user_id={$_GET['id']}";
                    $ch = $db->query($query);
                    $row = $ch->fetch();
                    echo "<form action='edit_user_teacher.php' method='post'id='edit' class='form-horizontal' enctype='multipart/form-data'>
                        <div class='mb-3'>
                    ...
                    echo"
                        ...
                        <div class='row'>
                            ...
                            <div class='col-3'>
                                <a href='manage_users_teacher.php' class='btn btn-info'> Quay lại</a>
                            </div>
                            <div class='col-7'>
                            </div>
                        </div>
